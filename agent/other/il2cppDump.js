...
},{"./main":39,"timers":35}],38:[function(require,module,exports){
"use strict";
...
require("frida-il2cpp-bridge"), exports.main = {
  start: function() {
    Il2Cpp.perform((() => {
      (0, e.log)("unity version:" + Il2Cpp.unityVersion), (0, e.log)("dump start"), Il2Cpp.dump("dump.cs", "/data/user/0/" + g_processName + "/"), 
      (0, e.log)("dump end");
    }));
  }
};

},{"./logger":38,"frida-il2cpp-bridge":29}]},{},[37])